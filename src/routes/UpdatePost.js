...
const UpdatePost = (props) => {
    ...
    useEffect(() => {
        ...
        setPost({
            ...
            Checkbox: props.Details.willDeliver,
        })
        // }
    }, [props])
    ...
    const submitForm = () => {
        ...
        fetch(`http://strangers-things.herokuapp.com/api/2010-UNF-HY-WEB-PT/posts/${ID}`, {
            method: "PATCH",
            headers: {
            ...
            .then(result => {
                console.log(result);
                if (result.success) {
                    setSuccessMessage("Your post is successfully updated")
                    setSuccess(true)
                }
                else {
    ...
    return (
        <div className="" style={{ backgroundColor: "lightgrey", padding: '2rem' }}>
            <div>
                <h1>Update Post</h1>
                <label>Title</label>
                <input
                ...
                <button onClick={validatePost}>UpdatePost</button><br />
